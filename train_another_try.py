...
from pretext_task.pretext_models_FPN import FPNBasedEncoder, FPNBasedDecoder, Discriminator, Discriminator_after_decoder, FPNBasedDecoderDilated, \
...
def main():
    if cfg.pretext:
        ...
        netD = Discriminator_after_decoder()
